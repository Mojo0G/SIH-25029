import { ArrowRight, ArrowUpRight, Upload, X, File, Image, Video, Music } from "lucide-react";
        ...
        <div className="grid items-center gap-8 lg:grid-cols-2">
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
            ...
            <h1 className="my-6 text-pretty text-4xl font-bold lg:text-6xl">
              ...
              <span className="text-green-600 dark:text-green-400 drop-shadow-[0_0_10px_rgba(34,197,94,0.8)]">AI</span>
              <span className="text-gray-900 dark:text-white"> Certificate Authentication System</span>
            </h1>
            <p className="text-muted-foreground mb-8 max-w-xl lg:text-xl">
              Revolutionary academic certificate verification using{" "}
              <span className="text-green-600 dark:text-green-400 font-semibold">blockchain technology</span>{" "}
              and{" "}
              <span className="text-green-600 dark:text-green-400 font-semibold">AI-powered fraud detection</span>
              . Upload certificates for instant verification, tamper-proof storage, and secure authentication in just 10 days of development.
            </p>
            <div className="flex w-full flex-col justify-center gap-2 sm:flex-row lg:justify-start">
              {buttons.primary && (
                <Button asChild className="w-full sm:w-auto bg-green-600 hover:bg-green-700 text-white border-green-600">
                  <a href={buttons.primary.url}>{buttons.primary.text}</a>
                </Button>
              )}
              {buttons.secondary && (
                <Button asChild variant="outline" className="w-full sm:w-auto border-green-500 text-green-600 hover:bg-green-50 dark:border-green-400 dark:text-green-400 dark:hover:bg-green-950/20">
          ...
          <div className="w-full max-w-2xl mx-auto">
            ...
            >
              ...
              <div className="flex flex-col items-center space-y-6">
                <div className={`p-6 rounded-full ${isDragOver ? 'bg-green-100 dark:bg-green-900/30' : 'bg-gray-100 dark:bg-gray-800'}`}>
                  <Upload className={`h-12 w-12 ${isDragOver ? 'text-green-600 dark:text-green-400' : 'text-gray-600 dark:text-gray-400'}`} />
                </div>
                ...
                <div>
                  ...
                  <p className="text-base text-gray-600 dark:text-gray-400 mb-6">
                    Secure blockchain verification with AI fraud detection. Only ZIP files containing certificates are accepted.
                  </p>
                  <Button
                    type="button"
                    variant="outline"
